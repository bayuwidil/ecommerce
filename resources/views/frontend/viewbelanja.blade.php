                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-one text-one">
                    ...
                    <div class="form-checkout shadow-set p-3 border rounded-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control text-two" name="kecamatan" id="validationDefault01" value="{{Auth::user()->kecamatan}}" readonly>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="validationDefault02" class="form-label fw-semibold text-one">Kode Pos</label>
                            <input type="text" class="form-control text-two" name="postcode" id="validationDefault02" value="{{Auth::user()->postcode}}" readonly>
                        </div>
                        <div class="col-md-12">
